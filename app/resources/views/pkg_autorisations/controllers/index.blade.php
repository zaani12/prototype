...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('pkg_autorisations/controllers/message.Controllers') }}</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    @can('downloadSeeder-GestionControllersController')
                        <form action="{{ route('controllers.download') }}" method="post">
                            ...
                            <button type="submit" class="btn btn-secondary mx-2"> <i class="fas fa-download"></i>
                                {{ __('pkg_autorisations/controllers/message.downloadControllers') }}
                            </button>
                        </form>
                        @endcan
                        ...
                        <a href="{{ route('controllers.create') }}" class="btn btn-info">
                            ...
                            {{ __('pkg_autorisations/controllers/message.addController') }}
                        </a>
                        @endcan
                    </div>
                </div>
