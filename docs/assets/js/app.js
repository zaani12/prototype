...
// todo_js : Création d'un script javascript qui permet d'afficher les figure par numéro 

// todo_js : Création d'un script javascript qui permet d'afficher un tableau des figures